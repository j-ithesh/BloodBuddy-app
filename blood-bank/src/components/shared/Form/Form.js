  ...
  return (
    <div>
      <form onSubmit={(e) => {
       ...
       {role === 'organisation' && (
         <InputType labelText={'OrganisationName'} labelFor={'fororganisationName'} InputType={'text'} name={'organisationName'} value={organisationName} onChange={(e) => setOrganisationName(e.target.value)}/>
       )}

       {role === 'hospital' && (
          <InputType labelText={'HospitalName'} labelFor={'forHospitalName'} InputType={'text'} name={'hospitalName'} value={hospitalName} onChange={(e) => setHospitalName(e.target.value)}/>
       )}
